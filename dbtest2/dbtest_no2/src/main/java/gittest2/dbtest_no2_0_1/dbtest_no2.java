...
package gittest2.dbtest_no2_0_1;
...
/**
 * Job: dbtest_no2 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.0.20160510_1709
 * @status 
 */
public class dbtest_no2 implements TalendJob {
	...
	private final String jobName = "dbtest_no2";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dbtest_no2.this, new Object[] { e,
	...
	public static class citywithcountryStruct implements
		...
		final static byte[] commonByteArrayLock_GITTEST2_dbtest_no2 = new byte[0];
		static byte[] commonByteArray_GITTEST2_dbtest_no2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_GITTEST2_dbtest_no2.length) {
					if (length < 1024
							&& commonByteArray_GITTEST2_dbtest_no2.length == 0) {
						commonByteArray_GITTEST2_dbtest_no2 = new byte[1024];
					} else {
						commonByteArray_GITTEST2_dbtest_no2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_GITTEST2_dbtest_no2, 0, length);
				strReturn = new String(commonByteArray_GITTEST2_dbtest_no2, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_GITTEST2_dbtest_no2) {
				...
				try {
					...
					this.GovernmentForm = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.GovernmentForm, dos);
					...
					while (rs_tMysqlInput_1.next()) {
						...
						{ // start of Var scope
							...
							if (!rejectedInnerJoin_tMap_1) {
								...
								citywithcountry_tmp.Population = row2.Population;
								citywithcountry_tmp.GovernmentForm = row2.GovernmentForm;
						...
						if (citywithcountry != null) {
							...
							strBuffer_tLogRow_1.append(String
									.valueOf(citywithcountry.Population));

							strBuffer_tLogRow_1.append("|");

							if (citywithcountry.GovernmentForm != null) { //

								strBuffer_tLogRow_1
										.append(String
												.valueOf(citywithcountry.GovernmentForm));
	...
	public static void main(String[] args) {
		final dbtest_no2 dbtest_no2Class = new dbtest_no2();

		int exitCode = dbtest_no2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dbtest_no2.class.getClassLoader()
					.getResourceAsStream(
							"gittest2/dbtest_no2_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dbtest_no2");
		}
...
/************************************************************************************************
 * 70920 characters generated by Talend Open Studio for ESB on the 29 June 2016
 * 13:34:17 BST
 ************************************************************************************************/
